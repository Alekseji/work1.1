// Создать переменные num1, num2 которые пользователь вводит 
// с клавиатуры  Проверьте, что переменная num1 равна или меньше 1, 
...
let num = parseInt (prompt("Введите число:", 74));
let sot=num/100;
let dec=num/10;
let ed = num%10;
console.log(sot, dec, ed);
